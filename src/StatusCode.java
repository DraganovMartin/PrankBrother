...
public abstract class StatusCode {
    ...
    public static final String[] statusCodes = {SLEEP_PC,GET_LIST_PROCESSES,KILL_A_PROCESS,HELP,EXIT,CHECK_CONNECTION,KILL_SERVER,SEND_KEYSTROKES,SEND_FILE,GET_FILES_TO_OPEN,OPEN_FILE_ON_SERVER,RESTART_PC,TERMINATE_PC,RESET_CONNECTION};
}
